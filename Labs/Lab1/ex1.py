...
if __name__ == '__main__':
    ...
    for discount in [0.5, 0.7, 0.9]:
        state, _ = env.reset()
        terminated = False
        policy, _ = value_iteration(env, env.action_space.n, env.observation_space.n, discount_factor=discount)
        total_reward = ...
    ...
    best_policy, _ = value_iteration(env, env.action_space.n, env.observation_space.n, discount_factor=best_discount)
...
# Discount: 0.5 : Reward: 6
# Discount: 0.7 : Reward: 6
# Discount: 0.9 : Reward: 14
# Average steps and average reward per iterations:
# Iterations 50: average steps: 14.18, average reward: -2.18
# Iterations 100: average steps: 13.93, average reward: -1.48
#
# which means that the function is prioritizing long-term rewards from the future
